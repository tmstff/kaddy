...
# quay.io/kaddy-bundle:$VERSION and quay.io/kaddy-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/tmstff/kaddy
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kaddy-builder
	$(CONTAINER_TOOL) buildx use kaddy-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kaddy-builder
	rm Dockerfile.cross
